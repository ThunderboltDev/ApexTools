...
export const config = {
  name: "ApexTools",
  description:
    "Find the best AI tools for any task: productivity, coding, marketing, writing & more. Explore our curated directory with reviews, comparisons and daily fresh additions.",
  url,
  creator: "Thunderbolt",
  themeColor: "#63a402",
} as const;
